...
describe('WebsitesList', () => {
    it('renders ServiceListTable component', ({ annotate }) => {
        annotate('Websites List: verifies the ServiceListTable child component is rendered in the DOM');
    ...
    it('sets page heading', ({ annotate }) => {
        annotate('Websites List: verifies the component mounts successfully and sets the page heading');
        const wrapper = mount(WebsitesList, mountOptions);
