...
4. If confirmed, run:
   ```bash
   /home/my/.nvm/versions/node/v22.22.2/bin/caliber learn add "<refined learning>"
   ```
   For personal preferences (not project-level), add `--personal`:
   ```bash
   /home/my/.nvm/versions/node/v22.22.2/bin/caliber learn add --personal "<refined learning>"
   ```
...
-> If yes: run `/home/my/.nvm/versions/node/v22.22.2/bin/caliber learn add "**[convention]** Push feature commits to the next branch, not master"`
