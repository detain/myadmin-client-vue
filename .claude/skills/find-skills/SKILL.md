...
3. If the user agrees, run:
   ```bash
   /home/my/.nvm/versions/node/v22.22.2/bin/caliber skills --query "<relevant terms>"
   ```
...
5. Install the selected skills:
   ```bash
   /home/my/.nvm/versions/node/v22.22.2/bin/caliber skills --install <slug1>,<slug2>
   ```
...
-> If yes: run `/home/my/.nvm/versions/node/v22.22.2/bin/caliber skills --query "react frontend"`
-> Show the user the results, ask which to install
-> Run `/home/my/.nvm/versions/node/v22.22.2/bin/caliber skills --install <selected-slugs>`
...
-> If yes: run `/home/my/.nvm/versions/node/v22.22.2/bin/caliber skills --query "docker deployment"`

User: "I need to write tests for this Python ML pipeline"
-> "Would you like me to find skills for Python ML testing?"
-> If yes: run `/home/my/.nvm/versions/node/v22.22.2/bin/caliber skills --query "python machine-learning testing"`
