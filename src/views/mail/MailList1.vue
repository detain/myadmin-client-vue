...
origData.value = [
    {screenshot: "<a href=\"index.php?choice=none.view_mail&id=376503\"><img src=\"https://shot.sh?w=300&h=100&img=hostingenuity.com\"></a>", mail_id: "376503", mail_hostname: "hostingenuity.com", mail_expire_date: "2022-02-09 16:20:25", cost: "12.00", mail_status: "active", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_mail&id=592337\"><img src=\"https://shot.sh?w=300&h=100&img=detain.dev\"></a>", mail_id: "592337", mail_hostname: "detain.dev", mail_expire_date: "2023-08-14 00:59:38", cost: "18.00", mail_status: "active", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_mail&id=418295\"><img src=\"https://shot.sh?w=300&h=100&img=unixsrv10.com\"></a>", mail_id: "418295", mail_hostname: "unixsrv10.com", mail_expire_date: "", cost: "11.00", mail_status: "canceled", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_mail&id=408615\"><img src=\"https://shot.sh?w=300&h=100&img=kirais.art\"></a>", mail_id: "408615", mail_hostname: "kirais.art", mail_expire_date: "", cost: "47.00", mail_status: "pending", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_mail&id=408918\"><img src=\"https://shot.sh?w=300&h=100&img=kiraart.bet\"></a>", mail_id: "408918", mail_hostname: "kiraart.bet", mail_expire_date: "", cost: "18.00", mail_status: "pending", link: "hi"}
];
const filteredData = computed(() => {
    if (limitStatus.value === 'all') {
      return origData.value;
    } else {
      return origData.value.filter(item => limitStatusMap[limitStatus.value].includes(item.mail_status));
    }
})
      ...
      <div class="card-header text-right">
        <div class="row float-right">
          <div id="header_btns" class="col-md-auto printer-hidden text-right pl-2">
            <div class="btn-group">
              <a class='btn btn-primary btn-sm printer-hidden' href='mail_order' data-toggle="tooltip" title="Order Mail Registrations"><i class='fa fa-shopping-cart'></i> Order</a>
            </div>
          </div>
            ...
            <div class="col-md-12">
                ...
                >
                  <template v-slot:link="{ value }">
                    <router-link :to="'view_mail?id=' + value" class="btn btn-primary btn-xs printer-hidden"><i class="fa fa-fw fa-cog"></i></router-link>
                  </template>
                  <thead>
                    <tr>
                      <th>Service ID</th>
