                                    ...
                                    <tbody>
                                        <tr v-for="(row, rowIndex) in data" :key="rowIndex" style="text-align: center">
                                            ...
                                            <td>
                                                ...
                                                <a href="#" :data-id="row.id" class="btn btn-primary btn-xs printer-hidden" title="Delete this Domain and its Records from DNS" @click.prevent="deleteDomain"><i class="fas fa-fw fa-trash" :data-id="row.id"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
