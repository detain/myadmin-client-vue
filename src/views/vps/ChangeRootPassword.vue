...
function submitForm() {
    if (password.value !== password2.value) {
        Swal.fire({
            icon: 'error',
            html: t('vps.changeRootPassword.passwordMismatch'),
        });
        return;
    }
    ...
    <div class="row justify-content-center py-3">
        <div class="col-md-6">
            <div class="card b-radius">
                <ServiceActionCardHeader :title="t('vps.changeRootPassword.title')" icon-class="fas fa-key" :back-to="'/' + moduleLink(module) + '/' + props.id" />
                <div class="card-body">
                    <form class="change_rootpass" @submit.prevent="submitForm">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="row justify-content-center">
                                <div class="controls">
                                    <input type="submit" name="change_pass" :value="t('vps.changeRootPassword.changePassword')" class="btn btn-order px-4 py-2 text-sm" />
                                </div>
                            </div>
                        </div>
                    </form>
