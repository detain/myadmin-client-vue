              ...
              <td>
                ...
                <ul>
                  <li>
                    ...
                    <a v-bind:href="setupVncLink" target="_blank" class="link text-bold" style="transition-duration:0.3s">Grant Your IP access to VNC </a>Please wait 2 minutes for the action to complete.
                  </li>
                  <li>
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="d-flex p-3">
          <table style="width: 15%;" class="table table-sm table-bordered mb-0">
            <tr>
              <td style="width: 100px;vertical-align: middle;">
                <img v-if="vpsScreenshot" style="height: 100px;" :src="vpsScreenshot" alt="VPS Screenshot">
                <img v-else style="height: 100px;" src="//i.ytimg.com/vi/B-3yfcIiLZc/maxresdefault.jpg">
              </td>
            </tr>
          </table>
          <div style="width: 85%;border: 1px solid #dee2e6;">
            <div class="p-2" style="border: 1px solid #dee2e6;">To connect using HTML5 VNC Client:
              <a class="ml-1 link text-bold" style="transition-duration:0.3s;" target="_blank" :href="novncLink">Click Here</a>
            </div>
            <div class="p-2" style="border: 1px solid #dee2e6;">
              To connect using old layout: <a class="ml-1 link text-bold" style="transition-duration:0.3s;" target="_blank" :href="`${novncLink}&mode=basic`">Click Here</a>
            </div>
            <div class="p-2" style="border: 1px solid #dee2e6;">
              HTML5 VNC client that runs well in any modern browser including mobile browsers (iOS and Android).
            </div>
          </div>
        </div>
      </div>
