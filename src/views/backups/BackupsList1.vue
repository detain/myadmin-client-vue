...
origData.value = [
    {screenshot: "<a href=\"index.php?choice=none.view_backup&id=376503\"><img src=\"https://shot.sh?w=300&h=100&img=hostingenuity.com\"></a>", backup_id: "376503", backup_hostname: "hostingenuity.com", backup_expire_date: "2022-02-09 16:20:25", cost: "12.00", backup_status: "active", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_backup&id=592337\"><img src=\"https://shot.sh?w=300&h=100&img=detain.dev\"></a>", backup_id: "592337", backup_hostname: "detain.dev", backup_expire_date: "2023-08-14 00:59:38", cost: "18.00", backup_status: "active", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_backup&id=418295\"><img src=\"https://shot.sh?w=300&h=100&img=unixsrv10.com\"></a>", backup_id: "418295", backup_hostname: "unixsrv10.com", backup_expire_date: "", cost: "11.00", backup_status: "canceled", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_backup&id=408615\"><img src=\"https://shot.sh?w=300&h=100&img=kirais.art\"></a>", backup_id: "408615", backup_hostname: "kirais.art", backup_expire_date: "", cost: "47.00", backup_status: "pending", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_backup&id=408918\"><img src=\"https://shot.sh?w=300&h=100&img=kiraart.bet\"></a>", backup_id: "408918", backup_hostname: "kiraart.bet", backup_expire_date: "", cost: "18.00", backup_status: "pending", link: "hi"}
];
const filteredData = computed(() => {
    if (limitStatus.value === 'all') {
      return origData.value;
    } else {
      return origData.value.filter(item => limitStatusMap[limitStatus.value].includes(item.backup_status));
    }
})
      ...
      <div class="card-header text-right">
        <div class="row float-right">
          <div id="header_btns" class="col-md-auto printer-hidden text-right pl-2">
            <div class="btn-group">
              <a class='btn btn-primary btn-sm printer-hidden' href='backup_order' data-toggle="tooltip" title="Order Backup Registrations"><i class='fa fa-shopping-cart'></i> Order</a>
            </div>
          </div>
            ...
            <div class="col-md-12">
                ...
                >
                  <template v-slot:link="{ value }">
                    <router-link :to="'view_backup?id=' + value" class="btn btn-primary btn-xs printer-hidden"><i class="fa fa-fw fa-cog"></i></router-link>
                  </template>
                  <thead>
                    <tr>
                      <th>Service ID</th>
