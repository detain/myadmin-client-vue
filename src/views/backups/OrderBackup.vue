                        ...
                        <form id="storage_form" method="post" class="storage_form_init" @submit.prevent="handleSubmit">
                            ...
                            <div class="row">
                                <div class="text-center col-md-12">
                                    <input type="submit" name="Submit" value="Continue" class="btn btn-order btn-sm py-2 px-3" />
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body text-md">
                        <div class="row mb-3">
                            ...
                            <div class="col text-right">
                                <span class="period">1</span> Month(s)
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3 cyclediscountrow">
                        ...
                        <form method="post" class="storage_form_confirm" :action="orderStorageUrl">
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>
                                            <div class="text-lg total_cost"></div>
                                        </th>
                                    </tr>
                                </tfoot>
                            </table>
                            ...
                            <div class="p-1">
                                ...
                                <p class="text-center text-sm">
                                    The subscription will automatically renew after <b>every month at</b>
                                    <span class="text-bold">{{ currencySymbol }}{{ orderData.data.renewal_cost || tosRepeatServiceCost }}</span> until canceled.
                                </p>
                            ...
                            <div class="form-group row">
                                <div class="text-center col-md-12"><input type="submit" name="Submit" value="Place Order" class="btn btn-green btn-sm px-3 py-2"></div>
                            </div>
                        </form>
                    </div>
                </div>
