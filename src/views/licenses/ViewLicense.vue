  ...
  <div class="col-12 col-sm-6 col-md-4">
    <div class="small-box bg-warning">
      ...
      <span class="small-box-footer">
        Status: <b>Disabled</b>
        <a class="btn p-0 text-white text-sm pl-1" href="view_license?id=592337&link=whois" title="Edit Whois Privacy Status"><i class="fa fa-pencil"></i>
        </a>
      </span>
    </div>
  </div>
      ...
      <div class="card-header">
        <div class="p-1">
          ...
          <div class="btn-group float-right">
            <a class="btn btn-custom btn-sm" href="view_license?id=592337&link=nameservers" title="Edit NameServers">
    ...
    <div class="card">
      <div class="card-header">
        <div class="p-1">
          ...
          <div class="btn-group float-right">
            <a class="btn btn-custom btn-sm" href="view_license?id=592337&link=contact" title="Edit Contact Information">
              <i class="fa fa-pencil" aria-hidden="true"></i>
              Edit </a>
          </div>
        </div>
