...
origData.value = [
    {license_id: "376503", license_hostname: "hostingenuity.com", license_expire_date: "2022-02-09 16:20:25", cost: "12.00", license_status: "active"},
    {license_id: "592337", license_hostname: "detain.dev", license_expire_date: "2023-08-14 00:59:38", cost: "18.00", license_status: "active"},
    {license_id: "418295", license_hostname: "unixsrv10.com", license_expire_date: "", cost: "11.00", license_status: "canceled"},
    {license_id: "408615", license_hostname: "kirais.art", license_expire_date: "", cost: "47.00", license_status: "pending"},
    {license_id: "408918", license_hostname: "kiraart.bet", license_expire_date: "", cost: "18.00", license_status: "pending"}
];

const filteredData = computed(() => {
  const activeLicenses = [];
  origData.value.forEach(row => {
      row.link = '<router-link to="\'view_license?id=' + row.license_id + '\'" class="btn btn-primary btn-xs printer-hidden"><i class="fa fa-fw fa-cog"></i></router-link>';
      row.link = row.license_id;
      row.hostname = '<router-link to="\'view_license?id=' + row.license_id + '\'">' + row.license_hostname + '</router-link>';
      if (limitStatus.value == 'all' || limitStatusMap[limitStatus.value].includes(row.license_status)) {
        activeLicenses.push(row);
      }
  });
