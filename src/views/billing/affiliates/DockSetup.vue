                ...
                <div class="card-header">
                    <div class="p-1">
                        <h3 class="card-title py-2">
                            <i class="fa fa-ticket">&nbsp;</i>Affiliate Landing Page Setup
                            (<a :href="`https://www.interserver.net/dock/vps-${data.accountId}.html`" class="link mt-0" target="_blank">View Landing Page</a>)
                        </h3>
