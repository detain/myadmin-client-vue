        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <div class="p-1">
                        <h3 class="card-title py-2"><font-awesome-icon :icon="['fas', 'ticket-alt']" />&nbsp;Affiliate Landing Page Setup (<a :href="`https://www.interserver.net/dock/vps-${user.account_id}.html`" class="link mt-0" target="_blank">View Landing Page</a>)</h3>
