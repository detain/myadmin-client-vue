...
function delete_prepay(prepay_id) {
    ...
    const { value: formValues } = Swal.fire({
        ...
        html:
            "<p>Are you sure want to delete your <strong>prepay #" +
            prepay_id +
            "</strong> and its related history ?</p>",
        preConfirm: () => {
            $("#deleteForm").submit();
        }
    });
        ...
        <template v-if="prepays">
            ...
            <div class="row py-3" v-if="prepays.length > 0">
                <div class="col text-left">
                    <h6 class="pl-3"><small>Showing page {{ page }} of {{ total_pages }} and {{ curr_page_records }} records out of {{ total_records }}</small></h6>
                </div>
                <div class="col">
