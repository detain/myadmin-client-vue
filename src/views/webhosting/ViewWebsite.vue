...
<div class="row my-4">
  <div class="col-12 col-sm-6 col-md-4">
    <div class="small-box bg-info">
      <div class="inner pt-3 pb-1 px-3">
        <h3>Package</h3>
        <p>.dev Website Name Registration</p>
  ...
  <div class="col-12 col-sm-6 col-md-4">
    <div class="small-box bg-success">
      ...
      <span class="small-box-footer">Website Status: <b>Active</b></span>
    </div>
  </div>
  <div class="col-12 col-sm-6 col-md-4">
    <div class="small-box bg-warning">
      ...
      <span class="small-box-footer">
        Status: <b>Disabled</b>
        <a class="btn p-0 text-white text-sm pl-1" href="view_website?id=592337&link=whois" data-toggle="tooltip" title="Edit Whois Privacy Status"><i class="fa fa-pencil"></i>
        </a>
      </span>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="card p-2">
      ...
      <div class="card-body py-5 text-center my-4" style="height: auto;">
        <a class="btn btn-app b-radius" href="view_website?id=592337&link=invoices"><i class="fas fa-file-invoice-dollar fa-w-12"></i>Invoices</a>
        <a class="btn btn-app b-radius" href="view_website?id=592337&link=cancel"><i class="fas fa-times"></i>Cancel Websites</a>
        <a class="btn btn-app b-radius" href="view_website?id=592337&link=renew"><i class="fa fa-hourglass"></i>Renew</a>
        <a class="btn btn-app b-radius" href="view_website?id=592337&link=dnssec"><i class="fa fa-lock"></i>DNSSEC</a>
        <a class="btn btn-app b-radius" href="view_website?id=592337&link=authepp"><i class="fa fa-envelope"></i>Email EPP Code</a>
        <a class="btn btn-app b-radius" href="view_website?id=592337&link=lock"><i class="fa fa-lock"></i>Lock / Unlock</a>
      </div>
    </div>
  </div>
      ...
      <div class="card-header">
        <div class="p-1">
          ...
          <div class="btn-group float-right">
            <a class="btn btn-custom btn-sm" href="view_website?id=592337&link=nameservers" data-toggle="tooltip" title="Edit NameServers">
...
<div class="row my-2">
    ...
    <div class="card">
      <div class="card-header">
        <div class="p-1">
          ...
          <div class="btn-group float-right">
            <a class="btn btn-custom btn-sm" href="view_website?id=592337&link=contact" data-toggle="tooltip" title="Edit Contact Information">
              <i class="fa fa-pencil" aria-hidden="true"></i>
              Edit </a>
          </div>
        </div>
  ...
  <div class="col-md-3">
    <div class="card p-2">
      <div class="card-header border-0">
        <h3 class="card-title"><i class="fas fa-newspaper">&nbsp;</i> Website Registry logs</h3>
        <div class="card-tools">
      ...
      <div class="card-body" style="height:250px;margin: 0 auto;display: flex;align-items: center;">
        <span class="text-secondary text-md">No website log found.</span>
      </div>
    </div>
  </div>
  <div class="col-md-3">
