...
origData.value = [
    {website_id: "376503", website_hostname: "hostingenuity.com", website_expire_date: "2022-02-09 16:20:25", cost: "12.00", website_status: "active"},
    {website_id: "592337", website_hostname: "detain.dev", website_expire_date: "2023-08-14 00:59:38", cost: "18.00", website_status: "active"},
    {website_id: "418295", website_hostname: "unixsrv10.com", website_expire_date: "", cost: "11.00", website_status: "canceled"},
    {website_id: "408615", website_hostname: "kirais.art", website_expire_date: "", cost: "47.00", website_status: "pending"},
    {website_id: "408918", website_hostname: "kiraart.bet", website_expire_date: "", cost: "18.00", website_status: "pending"}
];

const filteredData = computed(() => {
  const activeWebsites = [];
  origData.value.forEach(row => {
      row.link = '<router-link to="\'view_website?id=' + row.website_id + '\'" class="btn btn-primary btn-xs printer-hidden"><i class="fa fa-fw fa-cog"></i></router-link>';
      row.link = row.website_id;
      row.hostname = '<router-link to="\'view_website?id=' + row.website_id + '\'">' + row.website_hostname + '</router-link>';
      if (limitStatus.value == 'all' || limitStatusMap[limitStatus.value].includes(row.website_status)) {
        activeWebsites.push(row);
      }
  });
