                    ...
                    <div class="card-header">
                        <div class="p-1">
                            ...
                            <div class="card-tools float-end">
                                <router-link to="/qs" class="btn btn-custom btn-sm mt-0" data-bs-toggle="tooltip" title="Go Back"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;Back&nbsp;&nbsp;</router-link>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tr v-for="(details, value) in serverDetails" :key="value">
                                                <td>
                                                    <div class="form-check d-inline">
                                                        ...
                                                        <label class="text-bold form-check-label my-1" :for="'qs-' + value">&nbsp;</label>
                                                    </div>
                                                </td>
                                                <td>{{ value }}</td>
                                                <td>{{ details.cpu }}</td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col text-bold package_cost text-end">{{ serverDetails[qsId] ? serverDetails[qsId].cost : '' }}</div>
                        </div>
                        <hr />
                        <div class="row mb-3">
                            <div class="col-md-8 text-lg">Total</div>
                            <div id="totalcost" class="col text-bold total_cost text-end text-lg">{{ serverDetails[qsId] ? serverDetails[qsId].cost : '' }}</div>
                        </div>
                    </div>
                </div>
                <!-- End Order Summary -->
                        ...
                        <form method="post" class="quickserver_form_confirm" @submit.prevent="onSubmitConfirmation">
                            <table class="table-sm table-bordered table">
                                <thead>
                                    <tr>
                                        <th>
                                            <div class="text-bold float-start" style="position: relative; top: 5px">Server Name</div>
                                            <button type="button" class="btn btn-custom btn-sm float-end" name="update_values" data-bs-toggle="tooltip" title="Edit details" @click="step = 'orderform'"><i class="fas fa-pencil-alt"></i>&nbsp;Edit</button>
                                        </th>
                                        <th>
