...
origData.value = [
    {screenshot: "<a href=\"index.php?choice=none.view_qs&id=376503\"><img src=\"https://shot.sh?w=300&h=100&img=hostingenuity.com\"></a>", qs_id: "376503", qs_hostname: "hostingenuity.com", qs_expire_date: "2022-02-09 16:20:25", cost: "12.00", qs_status: "active", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_qs&id=592337\"><img src=\"https://shot.sh?w=300&h=100&img=detain.dev\"></a>", qs_id: "592337", qs_hostname: "detain.dev", qs_expire_date: "2023-08-14 00:59:38", cost: "18.00", qs_status: "active", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_qs&id=418295\"><img src=\"https://shot.sh?w=300&h=100&img=unixsrv10.com\"></a>", qs_id: "418295", qs_hostname: "unixsrv10.com", qs_expire_date: "", cost: "11.00", qs_status: "canceled", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_qs&id=408615\"><img src=\"https://shot.sh?w=300&h=100&img=kirais.art\"></a>", qs_id: "408615", qs_hostname: "kirais.art", qs_expire_date: "", cost: "47.00", qs_status: "pending", link: "hi"},
    {screenshot: "<a href=\"index.php?choice=none.view_qs&id=408918\"><img src=\"https://shot.sh?w=300&h=100&img=kiraart.bet\"></a>", qs_id: "408918", qs_hostname: "kiraart.bet", qs_expire_date: "", cost: "18.00", qs_status: "pending", link: "hi"}
];
const filteredData = computed(() => {
    if (limitStatus.value === 'all') {
      return origData.value;
    } else {
      return origData.value.filter(item => limitStatusMap[limitStatus.value].includes(item.qs_status));
    }
})
      ...
      <div class="card-header text-right">
        <div class="row float-right">
          <div id="header_btns" class="col-md-auto printer-hidden text-right pl-2">
            <div class="btn-group">
              <a class='btn btn-primary btn-sm printer-hidden' href='qs_order' data-toggle="tooltip" title="Order Qs Registrations"><i class='fa fa-shopping-cart'></i> Order</a>
            </div>
          </div>
            ...
            <div class="col-md-12">
                ...
                >
                  <template v-slot:link="{ value }">
                    <router-link :to="'view_qs?id=' + value" class="btn btn-primary btn-xs printer-hidden"><i class="fa fa-fw fa-cog"></i></router-link>
                  </template>
                  <thead>
                    <tr>
                      <th>Service ID</th>
