...
async function submitOrder() {
    try {
        ...
        const postData: SubmitPayload = {
            ...
            rootPassword: enablepassword.value ? rootPassword.value : generatePassword(),
                ...
                <table id="dedicated_server" class="table table-bordered table-striped dataTable">
                    ...
                    <tbody class="ui-widget-content">
                        ...
                        <template v-if="enablepassword">
                            ...
                            <tr>
                                <td colspan="6" style="text-align: left">
                                    <span><input id="root_pass" v-model="rootPassword" tabindex="0" type="text" name="rootpass" size="30" placeholder="Enter Password" class="form-control" autocomplete="off" /></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: left">
                        ...
                        <template v-else>
                            <tr>
                                <td colspan="6" style="text-align: left">
                                    <span><label class="m-0">{{ t('servers.order.rootPassword') }}</label></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style="text-align: left">
                                    <span><small class="form-text text-muted">{{ t('servers.order.passwordAutoGenerated', 'A secure password will be automatically generated for your server.') }}</small></span>
                                </td>
                            </tr>
                        </template>
                        <tr>
