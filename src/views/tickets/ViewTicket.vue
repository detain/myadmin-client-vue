                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control form-control-sm" name="body"
                                    placeholder="Detailed post about the issue" rows="7"></textarea>
                            </div>
                        </div>
                        <div class="form-group required row mb-0">
                            ...
                            <div class="controls col-sm-10 input-group input-file" name="file_attachment">
                                ...
                                <input type="text" name="file_attachment"
                                    class="form-control form-control-sm input-text-file" placeholder='Choose a file...' />
                                <span class="input-group-btn">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 input-group">
                                <span class="help-text text-orange">Note: Only image files - gif/jpeg/png types are
                                    allowed.</span>
                            </div>
                        </div>
                    </div>
          ...
          <div v-if="ticket_posts">
            <div v-for="post in ticket_posts" :key="post.id" class="card-comment">
              <div class="comment-text ml-4">
                <span class="username">
                  {{ post.fullname }} <span :class="post.staffid ? 'py-1 px-2 text-xs b-radius bg-green ml-1' : 'py-1 px-2 text-xs b-radius bg-green ml-1'"> {{ post.staffid ? 'Staff' : 'User' }}</span>
                ...
                <template v-if="post.liked !== undefined">
                  <button type="button" class="btn btn-secondary btn-sm bg-primary">
                    <i :class="post.liked == 1 ? 'far fa-thumbs-up' : 'far fa-thumbs-down'"></i> {{ post.liked == 1 ? 'Like' : 'Dislike' }}
                  </button>
                </template>
