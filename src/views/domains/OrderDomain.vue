    ...
    <form method="post" action="domain_order" class="search-domain">
      ...
      <div class="form-group row justify-content-center">
        <div class="col-md-5 input-group pb-2">
          <input id="domain_search" type="text" class="form-control" name="hostname" value="" autofocus="autofocus" onfocus=" let value = this.value; this.value = null; this.value=value" autocomplete="off" style="border-radius: 5px;">
        </div>
      </div>
      <div class="form-group row">
        <div class="controls col-md-12" style="text-align: center;">
          <button type="submit" class="btn btn-custom mr-2 px-4 py-2 text-sm">Search</button>
          <a target="blank" href="https://interserver.net/domains" class="btn btn-order px-3 py-2 text-sm">Check Prices</a>
        </div>
      </div>
    </form>
  </div>
