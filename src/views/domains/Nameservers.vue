...
<div class="card">
    <div class="card-header">
        <h3 class="card-title text-lg mt-1"><i class="m-0"><!-- <svg style="width: 40px; height: 40px;"><use xlink:href="/images/myadmin/MyAdmin-Icons.min.svg#icon-dns"></use></svg> --></i>Domain Name Servers</h3>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(ns, idx) in registered_nameservers" :key="idx">
                                <td>{{ ns.name }}</td>
                                <td>{{ ns.ipaddress }}</td>
                                <td><span :class="ns.can_delete == 1 ? 'text-green' : 'text-red'">{{ ns.can_delete == 1 ? 'Yes' : 'No' }}</span></td>
                                <td>
