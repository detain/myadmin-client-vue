                ...
                <div class="card-header text-right">
                    <div class="row float-right">
                        <div id="header_btns" class="col-md-auto printer-hidden pl-2 text-right">
                            <div class="btn-group">
                                <router-link class="btn btn-primary btn-sm printer-hidden" to="/floating_ips/order" title="Order Floating IPs Registrations"><i class="fa fa-shopping-cart"></i> Order</router-link>
                            </div>
                        </div>
