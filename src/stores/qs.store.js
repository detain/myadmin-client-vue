...
const baseUrl = `${import.meta.env.VITE_API_URL}/qs`;
...
export const useQsStore = defineStore({
    ...
    state: () => ({
        ...
        serviceMaster: {
            ...
            qs_iowait: "0",
            qs_raid_status:
                "OK: mdstat:[md0(1.86 GiB raid1):UU, md1(93.07 GiB raid1):UU]; zfs:all pools are healthy",
            qs_mounts:
                "udev:15:0:15:/dev,/dev/md1:91:14:77:/,securityfs:0:0:0:/sys/kernel/security,pstore:0:0:0:/sys/fs/pstore,systemd-1:0:0:0:/proc/sys/fs/binfmt_misc,debugfs:0:0:0:/sys/kernel/debug,tracefs:0:0:0:",
            qs_drive_type: "SATA",
            qs_order: "14682",
            qs_raid_building: "0",
    ...
    actions: {
        ...
        async getAll() {
            this.loading = true;
            try {
                let response = await fetchWrapper.get('https://mystage.interserver.net/apiv2/qs');
