...
const baseUrl = `${import.meta.env.VITE_API_URL}/websites`;
...
export const useWebsiteStore = defineStore({
    ...
    state: () => ({
        ...
        admin_links: [
            {
                label: "Edit Customer",
                link: "edit_customer?customer=2773",
                icon: "fas fa-duotone fa-address-card",
                icon_text: "",
                help_text: "Edit Customer"
            },
            {
                label: "Re-Assign",
                link: "service_reassign?module=webhosting&id=1196829",
                icon: "fas fa-duotone fa-people-arrows",
                icon_text: "",
                help_text: "Re-Assign To Different Customer"
            },
            {
                label: "Sudo Session",
                link: "sudo_session?custid=2773",
                icon: "fa fa-duotone fa-users-cog",
                icon_text: "",
                help_text: "Sudo Session"
            },
            {
                label: "View Balance",
                link: "view_balance?custid=2773",
                icon: "fa fa-duotone fa-file-invoice-dollar",
                icon_text: "",
                help_text: "View Balance"
            },
            {
                label: "Contact Info",
                link: "update_info?custid=2773",
                icon: "fa fa-duotone fa-address-card",
                icon_text: "",
                help_text: "View/Update Contact Info"
            },
            {
                label: "PrePay",
                link: "prepay_menu?custid=2773&module=webhosting",
                icon: "fa fa-duotone fa-wallet",
                icon_text: "",
                help_text: "Prepay"
            },
            {
                label: "Same Domain Customers",
                link: "same_domain_accounts?custid=2773&module=webhosting",
                icon: "fa fa-link",
                icon_text: "",
                help_text: "Get List of Same Domain Customers"
            },
            {
                label: "Wipe Service",
                link: "wipe_service?id=1196829&module=webhosting",
                icon: "fa fa-trash",
                icon_text: "",
                help_text: "Wipe Service From System"
            },
            {
                label: "Add Invoice",
                link: "create_service_bill?service=1196829&module=webhosting",
                icon: "fa fa-file-medical",
                icon_text: "",
                help_text: "Add New Invoice"
            },
            {
                label: "Repeat Invoices",
                link: "view_website?id=1196829&link=repeat_invoices",
                icon: "fa fa-history",
                icon_text: "",
                help_text: "Repeat Invoices"
            },
            {
                label: "Set Invoice Due Date",
                link: "give_more_time_to_pay?id=1196829&module=webhosting",
                icon: "fa fa-calendar-alt",
                icon_text: "",
                help_text: "Set Invoice Due Date"
            },
            {
                label: "Create Next Invoice",
                link: "create_next_invoice?r=20261994&module=webhosting",
                icon: "fa fa-file-medical",
                icon_text: "",
                help_text: "Set Invoice Due Date"
            },
            {
                label: "History Log",
                link: "view_website?id=1196829&link=history_log",
    ...
    actions: {
        ...
        async getAll() {
            this.loading = true;
            try {
                let response = await fetchWrapper.get('https://mystage.interserver.net/apiv2/websites');
