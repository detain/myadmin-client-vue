    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button type="button" class="btn-custom text-sm mr-2" data-toggle="modal" data-target="#createNew"><i class="fas fa-plus" aria-hidden="true">&nbsp;</i> Create New</button>
            </div>
        </div>
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            if (targetForm) {
                ...
                try {
                    fetchWrapper.post(`${baseUrl}/scrub_ips/${id.value}/delete_rule`, formDataValues).then((response) => {
                        Swal.close();
