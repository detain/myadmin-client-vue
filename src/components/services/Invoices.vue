...
function format(d: any) {
    ...
    if (typeof d[13] == 'undefined' || d[13].length == 0) {
        ...
        paid_content = '<table id="paid_content" class="display table table-striped table-sm table-hover" style="width:100%">' +
            '<thead>' +
            '<tr>' +
            '<th>&nbsp;</th>' +
            '<th>ID</th>' +
        ...
        for (let i: number = 0; i < d[13].length; i++) {
            ...
            paid_content = paid_content +
                '<tr>' +
                '<td class="details-control-refund sorting_disabled" style="width: 40px;">&nbsp;</td>' +
                '<td>' + d[13][i][0] + '</td>' +
                '<td>' + d[13][i][1] + '</td>' +
                '<td>' + trnx_col + '</td>' +
                '<td>' + d[13][i][12] + d[13][i][5] + '</td>' +
                '<td>' + payment_type + '</td>' +
                '<td>' + plinks + '</td>' +
                '</tr>';
            ...
            if (typeof d[13][i][13] == 'undefined' || d[13][i][13].length == 0) {
                ...
                refund_content = '<tr><td colspan="7"><table id="refund_rows" class="display table table-striped table-sm table-hover" style="width:100%">' +
                    '<thead>' +
                    '<tr>' +
                    '<th></th>' +
                    '<th>ID</th>' +
                ...
                for (let j = 0; j < d[13][i][13].length; j++) {
                    ...
                    refund_content = refund_content +
                        ...
                        '<td>' + d[13][i][13][j][1] + '</td>' +
                        '<td>' + trnx_col + '</td>' +
                        '<td>' + d[13][i][13][j][12] + d[13][i][13][j][5] + '</td>' +
                        '<td>' + links + '</td>' +
                        '</tr>';
                }
