                ...
                <tr v-for="alert in alerts" :key="alert.alert_id">
                  ...
                  <td style="max-width: 300px; overflow: hidden; white-space: nowrap;">
                    <a
                      ...
                      data-toggle="modal"
                      data-target="#add-new"
                      @click="editAlert('edit', alert.alert_id, alert.alert_type, alert.alert_value, alert.alert_to, alert.alert_enabled);"
                    >
                      Edit
                    </a>
                    <a
                      :href="'view_mail?id=' + id + '&link=alerts&action=delete&alert_id=' + alert.alert_id + '&csrf_token=' + csrfToken"
                      class="btn btn-sm btn-primary"
                    >
                      Delete
                    </a>
        ...
        <div class="modal-body mx-4">
          <form @submit.prevent="submitBlock" id="block-form">
            ...
            <div class="form-group row mx-auto">
              <label class="col-md-4 col-form-label px-0" for="notification_types">
